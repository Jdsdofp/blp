...
interface ICondition {
  dc_id: number;
  dc_condicoes: { [key: string]: boolean | null }; // Mapeamento de condições
}
...
export const DocumentShow = () => {
  ...
  // Função para alternar o valor da condição
  const toggleCondition = (key: string) => {
    setConditions((prevConditions) => {
      const currentValue = prevConditions[key];
      let newValue;
